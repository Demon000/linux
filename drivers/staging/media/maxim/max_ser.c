...
#define MAX_SER_FMT(_code, _dt, _bpp, _dbl)	\
{						\
	.code = (_code),			\
	.dt = (_dt),				\
	.bpp = (_bpp),				\
...
static const struct max_ser_format max_ser_formats[] = {
	MAX_SER_FMT(MEDIA_BUS_FMT_YUYV8_1X16, MAX_SER_DT_YUV422_8B, 16, 0),
	MAX_SER_FMT(MEDIA_BUS_FMT_YUYV10_1X20, MAX_SER_DT_YUV422_10B, 20, 0),
	MAX_SER_FMT(MEDIA_BUS_FMT_RGB565_1X16, MAX_SER_DT_RGB565, 16, 0),
	MAX_SER_FMT(MEDIA_BUS_FMT_RGB666_1X18, MAX_SER_DT_RGB666, 18, 0),
	MAX_SER_FMT(MEDIA_BUS_FMT_RGB888_1X24, MAX_SER_DT_RGB888, 24, 0),
	MAX_SER_FMT(MEDIA_BUS_FMT_SBGGR8_1X8, MAX_SER_DT_RAW8, 8, 1),
	MAX_SER_FMT(MEDIA_BUS_FMT_SGBRG8_1X8, MAX_SER_DT_RAW8, 8, 1),
	MAX_SER_FMT(MEDIA_BUS_FMT_SGRBG8_1X8, MAX_SER_DT_RAW8, 8, 1),
	MAX_SER_FMT(MEDIA_BUS_FMT_SRGGB8_1X8, MAX_SER_DT_RAW8, 8, 1),
	MAX_SER_FMT(MEDIA_BUS_FMT_SBGGR10_1X10, MAX_SER_DT_RAW10, 10, 1),
	MAX_SER_FMT(MEDIA_BUS_FMT_SGBRG10_1X10, MAX_SER_DT_RAW10, 10, 1),
	MAX_SER_FMT(MEDIA_BUS_FMT_SGRBG10_1X10, MAX_SER_DT_RAW10, 10, 1),
	MAX_SER_FMT(MEDIA_BUS_FMT_SRGGB10_1X10, MAX_SER_DT_RAW10, 10, 1),
	MAX_SER_FMT(MEDIA_BUS_FMT_SBGGR12_1X12, MAX_SER_DT_RAW12, 12, 1),
	MAX_SER_FMT(MEDIA_BUS_FMT_SGBRG12_1X12, MAX_SER_DT_RAW12, 12, 1),
	MAX_SER_FMT(MEDIA_BUS_FMT_SGRBG12_1X12, MAX_SER_DT_RAW12, 12, 1),
	MAX_SER_FMT(MEDIA_BUS_FMT_SRGGB12_1X12, MAX_SER_DT_RAW12, 12, 1),
	MAX_SER_FMT(MEDIA_BUS_FMT_SBGGR14_1X14, MAX_SER_DT_RAW14, 14, 0),
	MAX_SER_FMT(MEDIA_BUS_FMT_SGBRG14_1X14, MAX_SER_DT_RAW14, 14, 0),
	MAX_SER_FMT(MEDIA_BUS_FMT_SGRBG14_1X14, MAX_SER_DT_RAW14, 14, 0),
	MAX_SER_FMT(MEDIA_BUS_FMT_SRGGB14_1X14, MAX_SER_DT_RAW14, 14, 0),
	MAX_SER_FMT(MEDIA_BUS_FMT_SBGGR16_1X16, MAX_SER_DT_RAW16, 16, 0),
	MAX_SER_FMT(MEDIA_BUS_FMT_SGBRG16_1X16, MAX_SER_DT_RAW16, 16, 0),
	MAX_SER_FMT(MEDIA_BUS_FMT_SGRBG16_1X16, MAX_SER_DT_RAW16, 16, 0),
	MAX_SER_FMT(MEDIA_BUS_FMT_SRGGB16_1X16, MAX_SER_DT_RAW16, 16, 0),
};
			   ...
			   struct max_i2c_xlate *i2c_xlate)
{
	...
	ret = regmap_write(regmap, addr, i2c_xlate->src << 1);
	if (ret)
		return ret;

	ret = regmap_write(regmap, addr + 0x1, i2c_xlate->dst << 1);
	if (ret)
		return ret;
