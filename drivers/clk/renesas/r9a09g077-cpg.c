...
static const struct mssr_mod_clk r9a09g077_mod_clks[] __initconst = {
	...
	DEF_MOD("gpt0", 201, R9A09G077_CLK_PCLKGPTL),
	DEF_MOD("gpt1", 202, R9A09G077_CLK_PCLKGPTL),
	DEF_MOD("adc0", 206, R9A09G077_CLK_PCLKH),
	DEF_MOD("adc1", 207, R9A09G077_CLK_PCLKH),
	DEF_MOD("gpt2", 216, R9A09G077_CLK_PCLKGPTL),
	DEF_MOD("gpt3", 217, R9A09G077_CLK_PCLKGPTL),
	DEF_MOD("gpt4", 218, R9A09G077_CLK_PCLKGPTL),
	DEF_MOD("gpt5", 219, R9A09G077_CLK_PCLKGPTL),
	DEF_MOD("gpt6", 220, R9A09G077_CLK_PCLKGPTL),
	DEF_MOD("gpt7", 221, R9A09G077_CLK_PCLKGPTL),
	DEF_MOD("gpt8", 222, R9A09G077_CLK_PCLKGPTL),
	DEF_MOD("gpt9", 223, R9A09G077_CLK_PCLKM),
	...
	DEF_MOD("gpt10", 603, R9A09G077_CLK_PCLKM),
