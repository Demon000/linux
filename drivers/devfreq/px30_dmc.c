...
static const char * const px30_dts_timing[] = {
	"rockchip,rockchip,ddr2_speed_bin",
	"rockchip,rockchip,ddr3_speed_bin",
	"rockchip,rockchip,ddr4_speed_bin",
	"rockchip,rockchip,pd_idle",
	"rockchip,rockchip,sr_idle",
	"rockchip,rockchip,sr_mc_gate_idle",
	"rockchip,rockchip,srpd_lite_idle",
	"rockchip,rockchip,standby_idle",

	"rockchip,rockchip,auto_pd_dis_freq",
	"rockchip,rockchip,auto_sr_dis_freq",
	"rockchip,rockchip,ddr2_dll_dis_freq",
	"rockchip,rockchip,ddr3_dll_dis_freq",
	"rockchip,rockchip,ddr4_dll_dis_freq",
	"rockchip,rockchip,phy_dll_dis_freq",

	"rockchip,rockchip,ddr2_odt_dis_freq",
	"rockchip,rockchip,phy_ddr2_odt_dis_freq",
	"rockchip,rockchip,ddr2_drv",
	"rockchip,rockchip,ddr2_odt",
	"rockchip,rockchip,phy_ddr2_ca_drv",
	"rockchip,rockchip,phy_ddr2_ck_drv",
	"rockchip,rockchip,phy_ddr2_dq_drv",
	"rockchip,rockchip,phy_ddr2_odt",

	"rockchip,rockchip,ddr3_odt_dis_freq",
	"rockchip,rockchip,phy_ddr3_odt_dis_freq",
	"rockchip,rockchip,ddr3_drv",
	"rockchip,rockchip,ddr3_odt",
	"rockchip,rockchip,phy_ddr3_ca_drv",
	"rockchip,rockchip,phy_ddr3_ck_drv",
	"rockchip,rockchip,phy_ddr3_dq_drv",
	"rockchip,rockchip,phy_ddr3_odt",

	"rockchip,rockchip,phy_lpddr2_odt_dis_freq",
	"rockchip,rockchip,lpddr2_drv",
	"rockchip,rockchip,phy_lpddr2_ca_drv",
	"rockchip,rockchip,phy_lpddr2_ck_drv",
	"rockchip,rockchip,phy_lpddr2_dq_drv",
	"rockchip,rockchip,phy_lpddr2_odt",

	"rockchip,rockchip,lpddr3_odt_dis_freq",
	"rockchip,rockchip,phy_lpddr3_odt_dis_freq",
	"rockchip,rockchip,lpddr3_drv",
	"rockchip,rockchip,lpddr3_odt",
	"rockchip,rockchip,phy_lpddr3_ca_drv",
	"rockchip,rockchip,phy_lpddr3_ck_drv",
	"rockchip,rockchip,phy_lpddr3_dq_drv",
	"rockchip,rockchip,phy_lpddr3_odt",

	"rockchip,rockchip,lpddr4_odt_dis_freq",
	"rockchip,rockchip,phy_lpddr4_odt_dis_freq",
	"rockchip,rockchip,lpddr4_drv",
	"rockchip,rockchip,lpddr4_dq_odt",
	"rockchip,rockchip,lpddr4_ca_odt",
	"rockchip,rockchip,phy_lpddr4_ca_drv",
	"rockchip,rockchip,phy_lpddr4_ck_cs_drv",
	"rockchip,rockchip,phy_lpddr4_dq_drv",
	"rockchip,rockchip,phy_lpddr4_odt",

	"rockchip,rockchip,ddr4_odt_dis_freq",
	"rockchip,rockchip,phy_ddr4_odt_dis_freq",
	"rockchip,rockchip,ddr4_drv",
	"rockchip,rockchip,ddr4_odt",
	"rockchip,rockchip,phy_ddr4_ca_drv",
	"rockchip,rockchip,phy_ddr4_ck_drv",
	"rockchip,rockchip,phy_ddr4_dq_drv",
	"rockchip,rockchip,phy_ddr4_odt",
};

static const char * const rk3328_dts_ca_timing[] = {
	"rockchip,rockchip,ddr3a1_ddr4a9_de-skew",
	"rockchip,rockchip,ddr3a0_ddr4a10_de-skew",
	"rockchip,rockchip,ddr3a3_ddr4a6_de-skew",
	"rockchip,rockchip,ddr3a2_ddr4a4_de-skew",
	"rockchip,rockchip,ddr3a5_ddr4a8_de-skew",
	"rockchip,rockchip,ddr3a4_ddr4a5_de-skew",
	"rockchip,rockchip,ddr3a7_ddr4a11_de-skew",
	"rockchip,rockchip,ddr3a6_ddr4a7_de-skew",
	"rockchip,rockchip,ddr3a9_ddr4a0_de-skew",
	"rockchip,rockchip,ddr3a8_ddr4a13_de-skew",
	"rockchip,rockchip,ddr3a11_ddr4a3_de-skew",
	"rockchip,rockchip,ddr3a10_ddr4cs0_de-skew",
	"rockchip,rockchip,ddr3a13_ddr4a2_de-skew",
	"rockchip,rockchip,ddr3a12_ddr4ba1_de-skew",
	"rockchip,rockchip,ddr3a15_ddr4odt0_de-skew",
	"rockchip,rockchip,ddr3a14_ddr4a1_de-skew",
	"rockchip,rockchip,ddr3ba1_ddr4a15_de-skew",
	"rockchip,rockchip,ddr3ba0_ddr4bg0_de-skew",
	"rockchip,rockchip,ddr3ras_ddr4cke_de-skew",
	"rockchip,rockchip,ddr3ba2_ddr4ba0_de-skew",
	"rockchip,rockchip,ddr3we_ddr4bg1_de-skew",
	"rockchip,rockchip,ddr3cas_ddr4a12_de-skew",
	"rockchip,rockchip,ddr3ckn_ddr4ckn_de-skew",
	"rockchip,rockchip,ddr3ckp_ddr4ckp_de-skew",
	"rockchip,rockchip,ddr3cke_ddr4a16_de-skew",
	"rockchip,rockchip,ddr3odt0_ddr4a14_de-skew",
	"rockchip,rockchip,ddr3cs0_ddr4act_de-skew",
	"rockchip,rockchip,ddr3reset_ddr4reset_de-skew",
	"rockchip,rockchip,ddr3cs1_ddr4cs1_de-skew",
	"rockchip,rockchip,ddr3odt1_ddr4odt1_de-skew",
};

static const char * const rk3328_dts_cs0_timing[] = {
	"rockchip,rockchip,cs0_dm0_rx_de-skew",
	"rockchip,rockchip,cs0_dm0_tx_de-skew",
	"rockchip,rockchip,cs0_dq0_rx_de-skew",
	"rockchip,rockchip,cs0_dq0_tx_de-skew",
	"rockchip,rockchip,cs0_dq1_rx_de-skew",
...
static int px30_dmcfreq_probe(struct platform_device *pdev)
{
	 ...
	 * Following 4KB * N is used for dts parameters.
	 */
	page_num = DIV_ROUND_UP(sizeof(*data->ddr), PAGE_SIZE);
	arm_smccc_smc(ROCKCHIP_SIP_SHARE_MEM, page_num, SHARE_PAGE_TYPE_DDR,
		      0, 0, 0, 0, 0, &res);
	if (res.a0) {
