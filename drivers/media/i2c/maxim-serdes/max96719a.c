...
static int max96719a_gpio_set(struct gpio_chip *gc, unsigned int offset, int value)
{
	unsigned long config = pinconf_to_config_packed(PIN_CONFIG_OUTPUT, value);
	struct max96719a_priv *priv = gpiochip_get_data(gc);
...
static const struct max_serdes_tpg_entry max96719a_tpg_entries[] = {
	...
	MAX96719A_TPG_DT_ENTRIES(MEDIA_BUS_FMT_SRGGB16_1X16, MIPI_CSI2_DT_RAW16, 16),
	MAX96719A_TPG_DT_ENTRIES(MEDIA_BUS_FMT_SRGGB20_1X20, MIPI_CSI2_DT_RAW20, 20),
