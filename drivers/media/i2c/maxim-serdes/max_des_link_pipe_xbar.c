...
static const struct v4l2_subdev_video_ops max_des_link_pipe_xbar_video_ops = {
};
...
static const struct v4l2_subdev_ops max_des_link_pipe_xbar_subdev_ops = {
	.video = &max_des_link_pipe_xbar_video_ops,
					    ...
					    struct v4l2_device *v4l2_dev)
{
	...
	comp->num_sink_pads = priv->ops->num_links * priv->num_streams_per_link;
