...
#define RZ_MTU3_TIOR_CONST_LOW \
	(FIELD_PREP(RZ_MTU3_TIOR_IOB, RZ_MTU3_TIOR_OC_INIT_OUT_LO_LO_OUT) | \
	 FIELD_PREP(RZ_MTU3_TIOR_IOA, RZ_MTU3_TIOR_OC_INIT_OUT_LO_LO_OUT))

#define RZ_MTU3_TIOR_CONST_HIGH \
	(FIELD_PREP(RZ_MTU3_TIOR_IOB, RZ_MTU3_TIOR_OC_INIT_OUT_HI_HI_OUT) | \
	 FIELD_PREP(RZ_MTU3_TIOR_IOA, RZ_MTU3_TIOR_OC_INIT_OUT_HI_HI_OUT))
